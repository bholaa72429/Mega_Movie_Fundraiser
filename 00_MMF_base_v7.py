...
def get_ticket_cost():
    ...
    # get age so we can calculate ticket price
    age = int_check("Age: ")  # replace with function
...
def get_snack():
    ...
    valid_snacks = [
        ...
        ["M&Ms", "M&Ms", "mms", "mm", "m", "b"],  # first item is M&M
...
# Tickets Detail Formatting (uses currency function)
...
movie_frame.to_csv("tickets_details.csv")
